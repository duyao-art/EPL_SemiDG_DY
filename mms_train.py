...
def ini_model(restore=False, restore_from=None):
    if restore:
        model_path_l = './tmodel/original/' + 'l_' + str(restore_from)
        model_path_r = './tmodel/original/' + 'r_' + str(restore_from)
...
def train(label_loader, unlabel_loader_0, unlabel_loader_1, test_loader, val_loader, learning_rate, weight_decay, num_epoch, model_path, niters_per_epoch):
    ...
    for epoch in range(num_epoch):
        ...
        if val_dice > best_dice:
            ...
            model_name_l = './tmodel/original/' + 'l_' + model_path
            model_name_r = './tmodel/original/' + 'r_' + model_path
